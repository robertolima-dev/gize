...
//! JWT (HS256) auth, and a `require_auth` middleware that guards mutating routes (ADR-013).
//!
...
pub fn mod_rs() -> String {
    r#"//! Authentication: Argon2id password hashing + stateless JWT (HS256). See gize ADR-013.
//!
